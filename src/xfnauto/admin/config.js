let config = {
  ...
  api: {
    baseURL: window.location.host === 'admin.xfnauto.com' ? 'https://tomcat.xfnauto.com/tauto/management/admin' : 'http://111.230.170.36/tauto/management/admin'
  },
  pay: {
    url: window.location.host === 'admin.xfnauto.com' ? 'https://service.allinpay.com/gateway/index.do' : 'http://ceshi.allinpay.com/gateway/index.do'
  },
  baseData: {
